            ...
            <div class="section animated-row" data-section="slide01">
                <div class="section-inner">
					...
					<form action="submit">
						...
						<h4>Choose Major Symptoms</h4>
						<ul>
							<a href="abdominal.php"><li>Abdominal Pain</a>
							<a href="cough.php"><li>Cough</a>
							<a href="diarrhea.php"><li>Diarrhea</a>
							<a href="ear.php"><li>Ear Problem</a>
							<a href="eye.php"><li>Eye Problem</a>
							<a href="fever.php"><li>Fever</a>
							<a href="headache.php"><li>Headache</a>
							<a href="nasal.php"><li>Nasal congestion</a>
							<a href="vomit.php"><li>Vomiting</a>
							<a href="skin.php"><li>Skin Rashes</a>
							<a href="last.php"><li>Sore Throat</a>
							<a href="ur.php"><li>Urinary Problem</a>
						</ul>
